                ...
                <div className="container topbar bg-primary d-none d-lg-block">
                    <div className="d-flex justify-content-between">
                        <div className="top-info ps-2">
                            <small className="me-3"><i className="fas fa-map-marker-alt me-2 text-primary"></i> <a href="#" className="text-white">123 Street, New York</a></small>
                            <small className="me-3"><i className="fas fa-envelope me-2 text-primary"></i><a href="#" className="text-white">Email@Example.com</a></small>
                        </div>
                        ...
                        <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
                            ...
                            <div className="d-flex m-3 me-0">
                                ...
                                <a href="#" className="position-relative me-4 my-auto">
                                    ...
                                    <span className="position-absolute bg-primary rounded-circle d-flex align-items-center justify-content-center text-dark px-1" style={{top: "-5px", left: "15px", height: "20px", minWidth: "20px"}}>3</span>
                                </a>
